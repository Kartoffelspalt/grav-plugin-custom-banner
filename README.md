...
| `dismiss-cookie-max-age` | integer | Number of seconds to hide the banner after the visitor clicks the dismiss button. Defaults to `1800` (30 minutes). |
